<template>
  ...
  <ParallaxRowC ref="bladesRef" :filled-background="false">
    ...
    <h2>
      Our newest drone has even bigger rotor blades for the best updraft
      possible
    </h2>
  </ParallaxRowC>
  ...
  <ParallaxRowC ref="cameraRef" :filled-background="false">
    ...
    <h2>
      Equipped with the newest technology, our drone is capable of 4K 120fps
      footage thanks to Hasselblad
    </h2>
  </ParallaxRowC>
  <ParallaxRowC :filled-background="true">
    <RowItemC
  ...
  <ParallaxRowC ref="batteryRef" :filled-background="false">
    ...
    <h2>
      To make video shootings even better, our drone is able to deliver up to 10
...
export default {
  ...
  methods: {
    ...
    setCameraToDroneBattery: function () {
      cameraVector = new THREE.Vector3(0, -1.8, 0.35);
      rotation = 1.5;
    },
